...
**Oracle** 是把链外或聚合后的外部信息带给链上系统的机制。直觉上它像合约向外部世界打听“现在价格是多少”的信息窗口。工程上这意味着只要业务依赖 oracle，攻击者就会想办法影响它看到的世界。

**Flash Loan** 是指在单笔交易里完成借入、使用和归还的大额无抵押流动性。直觉上它像有人在一个时间片里瞬间借来一辆巨型卡车搬东西再马上还回去。工程上这意味着很多原本难以达到的攻击规模，会因为 flash loan 变得现实。

**操纵窗口（Manipulation Window）** 是攻击者能够在多大时间或状态范围内扭曲系统输入的机会窗口。直觉上它像门被推开的那几秒钟里，别人能塞进多少错误信息。工程上这意味着你不能只问“能不能操纵”，还要问“操纵能持续多久、成本多高”。
