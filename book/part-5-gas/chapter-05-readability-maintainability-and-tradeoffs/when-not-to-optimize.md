...
**可读性（Readability）** 是代码让后来阅读者快速理解意图和边界的能力。直觉上它像你给未来的自己和队友留下的说明书质量。工程上这意味着省掉几百 gas，如果换来长期误读和审查困难，未必是真优化。

**可维护性（Maintainability）** 是代码在需求变化和长期迭代中还能被稳妥修改的能力。直觉上它像系统未来还能不能在不拆房子的情况下装修。工程上这意味着很多极致优化写法，会把后续修改、排错和升级成本抬得很高。

**可审计性（Auditability）** 是代码是否足够清晰到让安全审查者高效判断风险。直觉上它像机器内部结构是不是愿意被人打开看懂。工程上这意味着过于炫技的优化经常会削弱审计效率，进而扩大真实风险。
