...
**Validator** 是共识里负责提议、证明和确认区块的验证者角色。直觉上它像账本系统里轮流负责记账和背书的人。工程上这意味着 finality、区块安全和出块节奏，都建立在验证者行为与激励上。

**Checkpoint** 是共识中被验证者特别标记、用于推进最终性的关键区块点位。直觉上它像整条路线上的固定路标，系统据此判断已经走到哪里。工程上这意味着 finality 不是每一块都同等处理，而是围绕 checkpoint 推进。

**经济最终性（Economic Finality）** 是通过高成本惩罚机制让回滚变得极不划算的最终性形式。直觉上它像不是物理上绝不可能翻案，而是翻案代价高到没人愿意承受。工程上这意味着理解 finality，既要看技术流程，也要看惩罚和激励。
