...
**Collateral** 是借贷仓位中用来支撑债务安全性的抵押资产。直觉上它像借钱时先押在系统里的担保物。工程上这意味着抵押品价格一旦大幅波动，借贷协议就会立刻进入风险管理模式。

**LTV** 是抵押物价值与可借债务比例之间的风险参数。直觉上它像系统愿意在你这份担保上放出多少杠杆。工程上这意味着 LTV 不是越高越好，而是协议在资本效率和风险之间做的取舍。

**Health Factor** 是衡量借贷仓位距离清算线还有多远的安全指标。直觉上它像仓位剩余缓冲垫的厚度。工程上这意味着前端预警、参数设计和清算机器人都会围绕 health factor 运作。
