...
**Perpetual** 是没有到期日、通过资金费率等机制维持价格锚定的永续合约。直觉上它像一场理论上不会自动散场、只能靠规则不断校准价格的衍生品交易。工程上这意味着永续协议的稳定性，核心在于怎样持续把价格拉回现货附近。

**Leverage** 是用较小本金放大市场敞口的杠杆机制。直觉上它像你站在更长的杠杆上撬动更大的头寸。工程上这意味着收益和风险都会被一起放大，协议必须更严密地管理保证金和清算。

**Funding Rate** 是永续多空双方定期支付、用来把价格拉回目标锚点的费率机制。直觉上它像一只周期性校准弹簧，把偏离的价格拉回中心。工程上这意味着永续市场能否长期贴近现货，很大程度取决于 funding rate 设计。
