...
**Reserve** 是池子或协议里作为定价和结算基础的资产储备。直觉上它像 AMM 池子里真正装着可供交换的库存。工程上这意味着池子的价格和可交易深度都直接受 reserve 状态支配。

**Liquidity** 是系统在不剧烈扭曲价格的前提下承接交易规模的能力。直觉上它像池子到底有多厚，能不能吃下大单而不把价格撞飞。工程上这意味着流动性不仅影响体验，也会影响套利、清算和协议稳定性。

**Slippage** 是预期价格与最终成交价格之间的偏移。直觉上它像你本来想按一个价成交，真正落地时却被市场推到了另一个价位。工程上这意味着池子越薄、交易越大、竞争越激烈，slippage 往往越明显。
