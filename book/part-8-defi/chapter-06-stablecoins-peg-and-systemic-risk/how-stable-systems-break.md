...
**Peg** 是稳定币或衍生资产试图锚定某个目标价格的关系。直觉上它像系统努力把一艘船拴在目标价位附近。工程上这意味着你评估稳定系统时，首先要看它靠什么维持 peg、失稳时靠什么拉回。

**Collateralization** 是系统用抵押资产为发行物或债务提供安全支撑的程度。直觉上它像这张票据背后到底压了多少真实担保。工程上这意味着抵押率高低会直接影响稳定系统的资本效率和抗冲击能力。

**Systemic Risk** 是局部问题向整套协议或多个协议层层扩散的系统性风险。直觉上它像一块地板塌了以后，连着几层一起被拖下去。工程上这意味着稳定系统不能只看单点逻辑，还要看压力会怎样沿结构传播。
