...
**Arbitrage** 是利用不同市场之间价格差异获利并推动价格回归的行为。直觉上它像哪里便宜买、哪里贵卖，同时顺手把两个地方价格拉近。工程上这意味着很多 AMM 和稳定系统之所以能恢复平衡，本质上依赖套利者愿意出手。

**MEV** 是交易排序和区块构造权带来的可提取价值。直觉上它像谁先谁后上台，本身就能变成钱。工程上这意味着很多协议行为不仅受代码约束，还受公开竞争排序环境影响。

**滑点保护（Slippage Protection）** 是限制最终成交价格偏离用户预期范围的保护参数。直觉上它像给交易设一条“再差也不能超过这里”的底线。工程上这意味着滑点保护既是用户体验功能，也是防排序和市场剧变的重要安全垫。
